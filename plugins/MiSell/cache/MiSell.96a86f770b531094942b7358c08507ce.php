...
function orderSend(){
    ...
    $("#orderServerInteraction").popup("open");
    var company_id=_selected_client.company_id;
    Connector.sendRequest({plugin:'MiSell',fn:'orderSend',order:JSON.stringify(_orderCache),company_id:company_id},function(resp){
...
<div data-role="page" id="orderPage">
   ...
   <!-- /content -->
    <div id="right-panel" data-role="panel" data-position="right" data-theme="b" data-display="push">
        <ul data-role="listview">
            <li><a href="#" onclick="orderCalculate()" data-rel="close" class="ui-btn ui-btn-inline ui-shadow ui-corner-all ui-btn-icon-left ui-icon-recycle">Расчитать</a></li>
