...
<html>
	...
	<script src="http://code.jquery.com/mobile/1.4.5/jquery.mobile-1.4.5.min.js"></script>
		...
		get_screen_size:function(){
		    ...
		    console.log(App.get_screen_size());
                    ...
                    loadSuggestions: function (q) {
                        ...
                        $.get("./suggest", {q: q, parent_id: _selectedStockCat, company_id: App.store('selected_client').company_id}, function (response) {
                            ...
                            $.each(suggested, function (i, val) {
                                ...
                                html += "<img src='../../Storage/image_flush/100x100/dynImg/"+val.product_img+"' onclick='return App.order.imgPopupShow(this);'>";
                                html += "<div style='display:inline-block;min-width:5em;text-align:right;color:#666;font-size:0.7em'>" + val.code + "</div>";
                                html += " <b>" + val.price + "</b> [" + val.product_quantity + "] <br><span> " + val.name + " </span></li>";
                            });
                            $ul.html(html);
                            $ul.listview("refresh");
	...
	<div data-role="popup" id="popupProductZoom" class="photopopup" data-overlay-theme="a" data-corners="false" data-tolerance="30,15">
