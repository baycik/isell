...
<Файл  ИдФайл="<?php echo $document_name; ?>" ВерсПрог="Инфо-Предприятие(версия 4.5.942)" ВерсФорм="5.07" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" ПризнНал8-12="1" ПризнНал8="1" ПризнНал81="0" ПризнНал9="1" ПризнНал91="0" ПризнНал10="0" ПризнНал11="0" ПризнНал12="0">
	<Документ КНД="1151001" ДатаДок="<?= date('d.m.Y'); ?>" Период="<?=$handled_period['date'] ?>" ОтчетГод="<?=$handled_period['year'] ?>" КодНО="9102" НомКорр="<?php echo $data['correction_num']; ?>" ПоМесту="214">
		<СвНП  Тлф="<?=str_replace('+','',$acomp_info->company_phone); ?>">
		...
		<НДС>
			<СумУплНП ОКТМО="<?=$fields->OKTMO; ?>" КБК="<?=$fields->KBK; ?>" СумПУ_173.1="<?=ceil($data['difference']->sum_vat) ?>" ПризнСЗПК="2" />
