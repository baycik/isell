...
class Stock extends Catalog {
    ...
    private function columnsGet($mode) {
        ...
        $adv = ",product_id, t.self_price,sell,buy,curr_code,product_img,product_spack,product_bpack,product_weight,product_volume,innerTable.party_label,analyse_origin,product_barcode,analyse_type,analyse_brand,analyse_class,product_article";
    ...
    public function listFetch($parent_id, $offset, $limit, $sortby, $sortdir, $filter = null, $mode = "simple") {
	    ...
	    FROM
			...
			LIMIT $limit OFFSET $offset) innerTable		
 		    LEFT JOIN
